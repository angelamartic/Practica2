...
```{r}
contar_simptomes$simptomes <- factor(contar_simptomes$simptomes, levels = c("Fatiga vocal"="Fatiga vocal", "Mucositat"="Mucositat","Necessitat d'aclarir la veu de manera persistent"="Aclarir la veu","Veu ronca"="Veu ronca"), labels = c("Fatiga vocal", "Mucositat","Aclarir la veu","Veu ronca"))
...
```
Un *p-valor* tan gran no ens permet rebutjar la hipòtesi nul·la de que les variables edat i símptomes siguin independents. No obstant, aquesta prova inferencial pot ser incorrecta pel escàs nombre de mostres.
